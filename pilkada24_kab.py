...
url_kab = 'https://sirekappilkada-obj-data.kpu.go.id/wilayah/pilkada/pkwkk/32/3207.json'
...
for kab in range(0, len(unique_kec)):
    ...
    url_kec = f'https://sirekappilkada-obj-data.kpu.go.id/wilayah/pilkada/pkwkk/32/3207/{kode_kec}.json'
    ...
    for kec in range(0, len(unique_kel)):
        ...
        url_kel = f'https://sirekappilkada-obj-data.kpu.go.id/wilayah/pilkada/pkwkk/32/3207/{kode_kec}/{kode_kel}.json'
        ...
        for kel in range(0, len(unique_tps)):
            ...
            url_kel = f'https://sirekappilkada-obj-data.kpu.go.id/pilkada/hhcw/pkwkk/32/3207/{kode_kec}/{kode_kel}/{kode_tps}.json'
            res = lp.get_response(requests, url_kel, sleep, random)
            data_pilkada = lp.get_data(nama_kec,nama_kel, nama_tps, res)
